...
* **Strikte JSON-Validierung:** Der Agent verwendet für alle erzeugten Artefakte ausschließlich das JSON-Format. Jedes gespeicherte JSON-Dokument wird vor dem Speichern zwingend gegen die Schema-Dateien im Verzeichnis `hilfsdateien` validiert, um absolute OSCAL-Konformität sicherzustellen.
